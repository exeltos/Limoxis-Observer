...
describe('LIRA provider runtime',()=>{
 ...
 it('respects tenant data-sharing switches',()=>{expect(edge).toContain('cfg.allow_aggregate_data?body.aggregateContext');expect(edge).toContain('cfg.allow_patient_level_data?body.patientContext')})
