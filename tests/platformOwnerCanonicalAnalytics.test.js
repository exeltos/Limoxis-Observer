...
describe('Platform Owner canonical analytics architecture',()=>{
  it('uses one shared AnalysisPage',()=>{expect(center).toContain('<AnalysisPage platform organizations={organizations} forceDemo={platformDemoPreview}/>');expect(center).not.toContain('openOrganizationAnalysis');expect(center).not.toContain('onOpenAnalysis=')})
