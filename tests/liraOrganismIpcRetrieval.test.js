...
describe('LIRA Phase 4D organism IPC and retrieval',()=>{
 ...
 it('gateway uses query-aware RPC',()=>{const g=fs.readFileSync('supabase/functions/lira-ai-gateway/index.ts','utf8');expect(g).toContain("rpc('search_lira_knowledge_text'");expect(g).not.toContain("rpc('get_lira_rag_chunks'")})
})
