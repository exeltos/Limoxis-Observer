...
describe('LIRA official knowledge starter pack',()=>{
 ...
 it('requires explicit approval in Management Center',()=>{const ui=fs.readFileSync('src/features/management/LiraKnowledgePanel.jsx','utf8');expect(ui).toContain("approve_lira_knowledge_source");expect(ui).toContain("x.status==='review'")})
})
