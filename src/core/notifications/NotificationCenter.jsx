...
export function NotificationCenter({open,onClose,onOpenBriefing,onOpenBirthday}){
 ...
 return <div className="notification-popover">
  ...
  <div className="notification-toolbar">
   <button onClick={onOpenBriefing}><Bell size={14}/>Σημερινή ενημέρωση</button>
   {n.birthday.length>0&&<button onClick={onOpenBirthday}><Gift size={14}/>Σημερινή ευχή</button>}
   {n.unreadCount>0&&<button onClick={n.markAllRead}><CheckCheck size={14}/>Όλα αναγνωσμένα</button>}
  </div>
