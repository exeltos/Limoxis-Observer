...
export function NotificationProvider({children}){
 ...
 const operational=useMemo(()=>{if(!isDemo)return liveOperational;const base=demoOperationalText[language==='en'?'en':'el'];const demoRole=role==='demo'?'hospital_admin':role;return (base[demoRole]||[]).map((x,i)=>({id:`TASK-${demoRole}-${i}`,title:x[0],count:x[1],to:x[2],type:'task'}))},[isDemo,role,language,liveOperational])
