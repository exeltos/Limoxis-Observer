export const helpExtras={
 ...
 '/prevention':{
  checks:{el:['Επιβεβαιώστε τμήμα και ημερομηνία καταγραφής.','Χρησιμοποιήστε την κατάλληλη βιβλιοθήκη/έκδοση δέσμης.','Ελέγξτε το αποτέλεσμα πριν την οριστική αποθήκευση.'],en:['Confirm department and record date.','Use the correct library/bundle version.','Review the calculated result before final save.']},
  tip:{el:'Η απλή καταχώρηση είναι σημαντικότερη από μια βαριά διαδικασία. Συμπληρώστε μόνο ό,τι χρειάζεται για αξιόπιστο δείκτη και τεκμηρίωση.',en:'Simple recording is more valuable than a heavy workflow. Capture only what is needed for reliable indicators and evidence.'},
 ...
 '/quality':{
  checks:{el:['Ελέγξτε υπεύθυνο, προθεσμία και κατάσταση κάθε CAPA.','Συνδέστε εύρημα και διορθωτική ενέργεια όπου υπάρχει σχέση.','Τεκμηριώστε την αποτελεσματικότητα πριν το τελικό κλείσιμο.'],en:['Review owner, due date and status for every CAPA.','Link findings to corrective actions where relevant.','Document effectiveness before final closure.']},
 ...
 '/training':{
  checks:{el:['Ελέγξτε συμμετέχοντες και παρουσίες.','Ολοκληρώστε την αξιολόγηση όπου απαιτείται.','Επιβεβαιώστε ότι το πιστοποιητικό εκδίδεται μόνο μετά την πραγματική ολοκλήρωση.'],en:['Review participants and attendance.','Complete the assessment where required.','Ensure certificates are issued only after actual completion.']},
 ...
 '/committees':{
  checks:{el:['Ελέγξτε απαρτία και συμμετέχοντες.','Καταγράψτε σαφείς αποφάσεις.','Κάθε ενέργεια παρακολούθησης πρέπει να έχει υπεύθυνο και προθεσμία.'],en:['Confirm quorum and participants.','Record clear decisions.','Every follow-up action should have an owner and deadline.']},
 ...
 '/pharmacy':{
  ...
  tip:{el:'Η ορθολογική χρήση αντιμικροβιακών σημαίνει ελεγχόμενη χρήση με τεκμηρίωση, όχι απλώς καταγραφή κατανάλωσης.',en:'Stewardship means controlled, documented use—not only consumption recording.'},
  related:['/surveillance','/indicators']
 },
 '/occupational-health':{
 ...
 '/lira':{
  checks:{el:['Διατυπώστε συγκεκριμένη ερώτηση.','Ελέγξτε τα υποκείμενα δεδομένα πριν από κρίσιμη απόφαση.','Μην θεωρείτε τη σύνοψη AI ως αυτόνομη κλινική απόφαση.'],en:['Ask a specific question.','Review the underlying records before a critical decision.','Do not treat an AI summary as an autonomous clinical decision.']},
