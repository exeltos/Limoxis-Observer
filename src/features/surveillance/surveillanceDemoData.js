export const surveillanceDemoData = [
  ...
  { id:'SUR-260032', patientId:'PT-260148', patient:'Ιωάννα Αντωνίου', patientEn:'Ioanna Antoniou', department:'Ορθοπαιδική', departmentEn:'Orthopedics', startedAt:'2026-07-14', organism:'Staphylococcus aureus', resistance:'MRSA', isolation:true, reviewDue:'2026-07-17', state:'completed', domains:{assessment:'completed',microbiology:'completed',therapy:'completed',isolation:'completed',reassessment:'completed'} },
  { id:'SUR-260028', patientId:'PT-260137', patient:'Σπυρίδων Μανώλης', patientEn:'Spyridon Manolis', department:'Καρδιολογική', departmentEn:'Cardiology', startedAt:'2026-06-10', organism:'Enterococcus faecium', resistance:'VRE', isolation:true, reviewDue:'2026-06-13', state:'completed', domains:{assessment:'completed',microbiology:'completed',therapy:'completed',isolation:'completed',reassessment:'completed'} },
  { id:'SUR-260023', patientId:'PT-260126', patient:'Άννα Νικολάου', patientEn:'Anna Nikolaou', department:'Παθολογική', departmentEn:'Internal Medicine', startedAt:'2026-05-18', organism:'Escherichia coli', resistance:'ESBL', isolation:true, reviewDue:'2026-05-21', state:'completed', domains:{assessment:'completed',microbiology:'completed',therapy:'completed',isolation:'completed',reassessment:'completed'} },
  { id:'SUR-260018', patientId:'PT-260115', patient:'Δημήτριος Οικονόμου', patientEn:'Dimitrios Oikonomou', department:'ΜΕΘ', departmentEn:'ICU', startedAt:'2026-04-06', organism:'Acinetobacter baumannii', resistance:'XDR', isolation:true, reviewDue:'2026-04-09', state:'completed', domains:{assessment:'completed',microbiology:'completed',therapy:'completed',isolation:'completed',reassessment:'completed'} },
  { id:'SUR-260013', patientId:'PT-260104', patient:'Κατερίνα Βασιλείου', patientEn:'Katerina Vasileiou', department:'Χειρουργική', departmentEn:'Surgery', startedAt:'2026-03-13', organism:'Pseudomonas aeruginosa', resistance:'MDR', isolation:true, reviewDue:'2026-03-16', state:'completed', domains:{assessment:'completed',microbiology:'completed',therapy:'completed',isolation:'completed',reassessment:'completed'} },
  { id:'SUR-260008', patientId:'PT-260093', patient:'Παναγιώτης Σταθόπουλος', patientEn:'Panagiotis Stathopoulos', department:'Παθολογική', departmentEn:'Internal Medicine', startedAt:'2026-02-09', organism:'Escherichia coli', resistance:null, isolation:false, reviewDue:'2026-02-12', state:'completed', domains:{assessment:'completed',microbiology:'completed',therapy:'completed',isolation:'notApplicable',reassessment:'completed'} }
