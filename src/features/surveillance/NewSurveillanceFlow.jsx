...
export function NewSurveillanceFlow({patient=null,patients=[],departments=[],initialSample=null,onClose,onCreate,onSaveAssessment,onRequestSample,onSaveIsolation,onRecordChange,onPatientsChange}){
  ...
  function cancelFlow(){if(record){const message=language==='el'?'Η επιτήρηση έχει ήδη δημιουργηθεί. Για ακύρωση μετά τη δημιουργία χρησιμοποιήστε «Διαγραφή επιτήρησης» από το μενού ενεργειών, ώστε να ζητηθεί αιτιολογία και να διατηρηθεί το ιστορικό.':'The surveillance has already been created. Use “Delete surveillance” from its actions menu so a reason and audit history are retained.';notify(message,'warning');return}closeFlow()}
