...
function CloudClinicalJourney({record,t,fmtDate,fmtDateTime,canAssess,canLab,canEdit,canClassifyResistance,canIsolation,canTherapy,canOpenPharmacy,canReassess,canOutcome,canDelete,canReopen,onSaved,tenantId}){
  const {notify}=useFeedback()
  const navigate=useNavigate()
