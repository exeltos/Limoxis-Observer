...
function CloudClinicalJourney({record,t,language,fmtDate,fmtDateTime,canAssess,canEdit,canClassifyResistance,canIsolation,canTherapy,canReassess,canOutcome,onSaved,tenantId}){
  const {notify}=useFeedback()
