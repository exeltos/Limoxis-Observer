...
export async function loadLiraData({isDemo=false,organizationId=null}={}){
  ...
  const [departmentsRes,patientsRes,casesRes,reassessmentsRes,isolationRes,samplesRes,resultsRes,handRes,bundleRes,incidentRes,capaRes,patientDayPeriodsRes,haiRes,devicesRes]=await Promise.all([
  ...
  const responses=[departmentsRes,patientsRes,casesRes,reassessmentsRes,isolationRes,samplesRes,resultsRes,handRes,bundleRes,incidentRes,capaRes,patientDayPeriodsRes,haiRes,devicesRes]
