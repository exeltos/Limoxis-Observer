...
import { ClipboardCheck,Droplets,Pencil,Plus,Recycle,ShieldCheck } from 'lucide-react'
...
function EditCell({record,canEdit,onEdit,t}){return <td className="prevention-row-action">{canEdit&&<ActionButton iconOnly label={t('edit')} tone="edit" onClick={e=>onEdit(record,e)}><Pencil size={16}/></ActionButton>}</td>}
