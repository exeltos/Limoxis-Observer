...
function EditCell({record,canEdit,onEdit,t}){return <td className="prevention-row-action">{canEdit&&<OverflowMenu items={[{id:'correct',label:t('edit'),icon:Pencil,onClick:()=>onEdit(record)}]}/>}</td>}
