...
export function ControlRecordPage(){
 ...
 if(!record)return <Page title="Έλεγχοι"><div className="inline-empty">Δεν βρέθηκε ο έλεγχος.</div></Page>
