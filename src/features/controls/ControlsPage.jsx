...
export function ControlsPage(){
 ...
 return <Page fill className="registry-fill-page" title={t('controls')} subtitle={canManage?tx.centralSubtitle:tx.departmentSubtitle} actions={canCreate?<RecordActions actions={[UI_ACTIONS.CREATE]} onAction={pageAction}/>:null}>
  ...
  <section className="surface registry-workspace workspace-fill workspace-column">
