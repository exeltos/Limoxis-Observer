...
export function ControlsPage(){
 ...
 if(editorOpen)return <ControlEditor departmentOnly={canCreateDepartment} fixedDepartment={canCreateDepartment?ownDepartment:''} onCancel={()=>setEditorOpen(false)} onSave={saveNew}/>
