...
function RegistryEmpty({title,subtitle=''}){return <div className="registry-empty-state employee-registry-empty"><strong>{title}</strong>{subtitle&&<span>{subtitle}</span>}</div>}
