...
function hospitalAdminWorkspace(english){
  return english?{
    ...
    subtitle:'Administrative overview of the organization, users, departments and operational pending work.',
    kpis:[['Active users','—'],['Active departments','—'],['Pending actions','—'],['Critical notifications','—']],
    actionTitle:'Administrative pending work',
    tasks:['Users requiring activation or access review','Pending organization settings','Audit events requiring administrative review'],
    focusTitle:'Organization status',
    focus:'Operational oversight',
    focusText:'Organization-wide operational visibility without intervention in specialist clinical decisions.',
  }:{
    title:'Επισκόπηση Νοσοκομείου',
    subtitle:'Διοικητική εικόνα του οργανισμού, των χρηστών, των τμημάτων και των λειτουργικών εκκρεμοτήτων.',
    kpis:[['Ενεργοί χρήστες','—'],['Ενεργά τμήματα','—'],['Εκκρεμείς ενέργειες','—'],['Κρίσιμες ειδοποιήσεις','—']],
    actionTitle:'Διοικητικές εκκρεμότητες',
    tasks:['Χρήστες που χρειάζονται ενεργοποίηση ή έλεγχο πρόσβασης','Εκκρεμείς ρυθμίσεις οργανισμού','Συμβάντα καταγραφής που χρειάζονται διοικητικό έλεγχο'],
    focusTitle:'Κατάσταση οργανισμού',
    focus:'Λειτουργική εποπτεία',
    focusText:'Συνολική εικόνα της λειτουργίας του νοσοκομείου χωρίς παρέμβαση στις εξειδικευμένες κλινικές αποφάσεις.',
  }
}
