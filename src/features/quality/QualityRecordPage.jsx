...
export function QualityRecordPage(){
  ...
  return <Page fill><EntityRecordShell
    ...
    tabs={tabs} activeTab={tab} onTabChange={setTab}>
      {tab==='details'&&<QualityDetails recordType={recordType} record={record} setRecord={setRecord} t={t} language={language} locale={locale} canManage={canManage} notify={notify} actor={actor} finalized={finalized} onDeleted={goBack} organizationId={organizationId}/>}
...
function QualityDetails({recordType,record,setRecord,t,language,locale,canManage,notify,actor,finalized,onDeleted,organizationId}){
