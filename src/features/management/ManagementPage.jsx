...
export function ManagementPage({global=false,onBack}={}){
 ...
 const tabs=useMemo(()=>{
  ...
  ...(ok(CAPABILITIES.MANAGE_USERS)?[{id:'users',label:t('users'),icon:Users},{id:'liraAi',label:'LIRA & AI',icon:KeyRound}]:[]),
