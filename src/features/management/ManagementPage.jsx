...
export function ManagementPage(){
  ...
  async function createUser({fullName,role:newRole,email,phone,jobTitle}){
    ...
    try{
      const data=await invokeAuthenticatedFunction('create-organization-user',{organizationId:tenant.id,fullName,role:newRole,email,phone,jobTitle})
      setCreatedUser(data)
      setCreateUserOpen(false)
    }catch(error){
      notify(error?.message||t('managementPanel.userCreationFailed'),'error')
    }
  }
