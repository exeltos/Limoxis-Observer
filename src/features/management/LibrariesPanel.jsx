...
export function LibrariesPanel(){
 ...
 return <section className="management-section management-scroll-section">
  ...
  <div className="library-governance-strip"><LockKeyhole size={15}/><div><strong>{t('librariesGovernanceStripTitle')}</strong><span>{t('librariesGovernanceStripText')}</span></div></div>
