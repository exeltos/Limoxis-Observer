...
function mapSample(row,patient,department,microbiology=[]){
  ...
  return {
    ...
    patientId:patient?.patient_code||subjectCode||row.patient_id,
    patient:patientName||subjectName,
    patientEn:patientName||subjectName,
    subjectType,
    subjectName,
    subjectCode,
