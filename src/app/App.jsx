...
export function App(){return <><GlobalTextareaExpander/><PlatformMaintenanceBanner/><Routes>
 ...
 <Route element={<ProtectedRoute/>}><Route path="training-access/:token" element={<Suspense fallback={<RouteLoading/>}><TrainingAccessPage/></Suspense>}/><Route element={<AppShell/>}>
  ...
  <Route path="indicators" element={<Suspense fallback={<RouteLoading/>}>{gate(CAPABILITIES.VIEW_INDICATORS,<IndicatorsPage/>)}</Suspense>}/><Route path="indicators/new" element={<Suspense fallback={<RouteLoading/>}>{gate(CAPABILITIES.MANAGE_INDICATORS,<IndicatorCreatePage/>)}</Suspense>}/>
  ...
  <Route path="pharmacy" element={<Suspense fallback={<RouteLoading/>}>{gate(CAPABILITIES.VIEW_PHARMACY,<PharmacyPage/>)}</Suspense>}/><Route path="occupational-health" element={<Suspense fallback={<RouteLoading/>}>{gate(CAPABILITIES.VIEW_OCCUPATIONAL_HEALTH,<OccupationalHealthPage/>)}</Suspense>}/><Route path="lira" element={<Suspense fallback={<RouteLoading/>}>{gate(CAPABILITIES.VIEW_LIRA,<LiraPage/>)}</Suspense>}/><Route path="management" element={<Suspense fallback={<RouteLoading/>}>{gateAny(MANAGEMENT_CAPABILITIES,<ManagementPage/>)}</Suspense>}/><Route path="*" element={<Navigate to="/" replace/>}/>
 </Route></Route>
 </Routes></>}
